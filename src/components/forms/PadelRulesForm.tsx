...
import { knockoutSeats, padelScoreType, padelSets } from "@/lib/constants";
...
const RulesSchema = z.object({
  ...
  total_sets: z.string().min(1, "Total Sets is required"),
});
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <Select
                      {...field}
                      onValueChange={(value) => {
                        form.setValue("total_sets", value);
                      }}
                    >
                      <SelectTrigger className="w-full">
                        <SelectValue placeholder="Pilih total sets" />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectGroup>
                          {padelSets.map((item) => (
